...
// // 1 Use the Array.filter function to create an array of all the pets owned by Luke. Changed to Arrow Function
...
// // 2 Use the Array.map function to create an array of all the names of the owners.Changed to Arrow Function
...
// // 3 Use the Array.find function to retrieve the pet owned by Shaggy Changed to Arrow Function
// const findShaggysPet = pet => pet.ownerName == "Shaggy";

// let shaggysPet = pets.find(findShaggysPet);
// console.log(shaggysPet);

// // 4 Use the Array.filter function to create an array of all the pets that are less than 5 years old and that have either a pet or owner name that starts with "S" Changed to Arrow Function
...
// CHANGING PREDEFINED FUNCTION TO ARROW
